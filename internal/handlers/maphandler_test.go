...
// Test_MapHandler_EntryExists_Log tests MapHandler's log output when the entry is in the database
func Test_MapHandler_EntryExists_Log(t *testing.T) {
	testLog := &utils.TestLogger{}
	testDB := utils.NewTestDatabase(testLog)
...
// Test_MapHandler_NoEntry_Log tests MapHandler's log output when their is no entry in the database
func Test_MapHandler_NoEntry_Log(t *testing.T) {
	testLog := &utils.TestLogger{}
	testDB := utils.NewTestDatabase(testLog)
